...
public class StreetSensors {
	...
	public static void main(String[] args) {
		...
		while(!exit){
			try {
				System.out.println("Welcome to the Street Sensor System\nPlease Enter Your username:");
				...
				if(tc.logon(username, pwd)==-1){
					System.out.println("Username incorrect");
				}
				else if(tc.logon(username, pwd)==1){
...
//////////////////////////////////////////////////////////////////////////
					...
					switch(userType){
						case 0:
							System.out.println("Maintenance User - Please Enter Command:");
							line = br.readLine();
							sc = new Scanner(line);
							sc.useDelimiter(",\\s*");
							String cmd = sc.next();
							switch(cmd){
								...
								case "getSensor":
									...
									if(s!=null){
										...
										System.out.println("That sensor does not exist");
									}
									break;
...
//////////////////////////////////////////////////////////////////////////
						...
						case 1:
							System.out.println("Admin User - Please Enter Command:");
							line = br.readLine();
							sc = new Scanner(line);
							sc.useDelimiter(",\\s*");
							cmd = sc.next();
							switch(cmd){
								...
								//Command: addSensor, Sensor ID, Street ID#, Section number, threshold
								case "addSensor": 
